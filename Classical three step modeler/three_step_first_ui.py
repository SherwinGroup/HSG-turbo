...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.lineEdit_h_ke_rec = QtWidgets.QLineEdit(self.frame)
        ...
        self.gridLayout_2.addWidget(self.lineEdit_h_ke_rec, 21, 1, 1, 1)
        self.label_total_ke_rec = QtWidgets.QLabel(self.frame)
        self.label_total_ke_rec.setObjectName(_fromUtf8("label_total_ke_rec"))
        self.gridLayout_2.addWidget(self.label_total_ke_rec, 19, 0, 1, 1)
        self.label_phi = QtWidgets.QLabel(self.frame)
        ...
        self.lineEdit_e_ke_rec = QtWidgets.QLineEdit(self.frame)
        ...
        self.gridLayout_2.addWidget(self.lineEdit_e_ke_rec, 20, 1, 1, 1)
        self.lineEdit_m_e_eff = QtWidgets.QLineEdit(self.frame)
        ...
        self.lineEdit_recollision_duration = QtWidgets.QLineEdit(self.frame)
        self.lineEdit_recollision_duration.setMinimumSize(QtCore.QSize(50, 0))
        self.lineEdit_recollision_duration.setMaximumSize(QtCore.QSize(55, 16777215))
        self.lineEdit_recollision_duration.setObjectName(_fromUtf8("lineEdit_recollision_duration"))
        self.gridLayout_2.addWidget(self.lineEdit_recollision_duration, 18, 1, 1, 1)
        self.label_time_fs = QtWidgets.QLabel(self.frame)
        ...
        self.lineEdit_slew_rate_time_fs = QtWidgets.QLineEdit(self.frame)
        ...
        self.label_diabatic_prob = QtWidgets.QLabel(self.frame)
        ...
        self.label_m_e_eff = QtWidgets.QLabel(self.frame)
        ...
        self.label_LZ_group = QtWidgets.QLabel(self.frame)
        ...
        self.label_e_ke_rec = QtWidgets.QLabel(self.frame)
        self.label_e_ke_rec.setObjectName(_fromUtf8("label_e_ke_rec"))
        self.gridLayout_2.addWidget(self.label_e_ke_rec, 20, 0, 1, 1)
        ...
        self.lineEdit_e_bind = QtWidgets.QLineEdit(self.frame)
        ...
        self.lineEdit_keldysh = QtWidgets.QLineEdit(self.frame)
        ...
        self.gridLayout_2.addWidget(self.lineEdit_keldysh, 23, 1, 1, 1)
        self.label_ponderomotive = QtWidgets.QLabel(self.frame)
        ...
        self.gridLayout_2.addWidget(self.label_ponderomotive, 24, 0, 1, 1)
        self.label = QtWidgets.QLabel(self.frame)
        self.label.setMinimumSize(QtCore.QSize(100, 0))
        self.label.setObjectName(_fromUtf8("label"))
        self.gridLayout_2.addWidget(self.label, 11, 0, 1, 1)
        self.lineEdit_diabatic_prob = QtWidgets.QLineEdit(self.frame)
        ...
        self.lineEdit_tot_ke_rec = QtWidgets.QLineEdit(self.frame)
        ...
        self.gridLayout_2.addWidget(self.lineEdit_tot_ke_rec, 19, 1, 1, 1)
        self.lineEdit_thz_freq = QtWidgets.QLineEdit(self.frame)
        ...
        self.lineEdit_slew_rate = QtWidgets.QLineEdit(self.frame)
        ...
        self.label_splitting = QtWidgets.QLabel(self.frame)
        ...
        self.lineEdit_splitting_meV = QtWidgets.QLineEdit(self.frame)
        ...
        self.lineEdit_phase = QtWidgets.QLineEdit(self.frame)
        ...
        self.label_h_ke_rec = QtWidgets.QLabel(self.frame)
        self.label_h_ke_rec.setObjectName(_fromUtf8("label_h_ke_rec"))
        self.gridLayout_2.addWidget(self.label_h_ke_rec, 21, 0, 1, 1)
        self.label_max_sbs = QtWidgets.QLabel(self.frame)
        ...
        self.gridLayout_2.addWidget(self.label_max_sbs, 25, 0, 1, 1)
        self.label_keldysh = QtWidgets.QLabel(self.frame)
        ...
        self.gridLayout_2.addWidget(self.label_keldysh, 23, 0, 1, 1)
        self.label_thz_freq = QtWidgets.QLabel(self.frame)
        ...
        self.lineEdit_ponderomotive = QtWidgets.QLineEdit(self.frame)
        ...
        self.gridLayout_2.addWidget(self.lineEdit_ponderomotive, 24, 1, 1, 1)
        self.lineEdit_thz_field = QtWidgets.QLineEdit(self.frame)
        ...
        self.label_thz_field = QtWidgets.QLabel(self.frame)
        ...
        self.label_rec_group = QtWidgets.QLabel(self.frame)
        ...
        self.label_m_h_eff = QtWidgets.QLabel(self.frame)
        ...
        self.lineEdit_approx_sb = QtWidgets.QLineEdit(self.frame)
        ...
        self.lineEdit_m_h_eff = QtWidgets.QLineEdit(self.frame)
        ...
        self.label_approx_sb = QtWidgets.QLabel(self.frame)
        ...
        self.label_e_bind = QtWidgets.QLabel(self.frame)
        ...
        self.label_recollision_time = QtWidgets.QLabel(self.frame)
        self.label_recollision_time.setObjectName(_fromUtf8("label_recollision_time"))
        self.gridLayout_2.addWidget(self.label_recollision_time, 18, 0, 1, 1)
        self.lineEdit_max_sbs = QtWidgets.QLineEdit(self.frame)
        ...
        self.gridLayout_2.addWidget(self.lineEdit_max_sbs, 25, 1, 1, 1)
        self.label_2 = QtWidgets.QLabel(self.frame)
        self.label_2.setObjectName(_fromUtf8("label_2"))
        self.gridLayout_2.addWidget(self.label_2, 16, 0, 1, 1)
        self.label_3 = QtWidgets.QLabel(self.frame)
        self.label_3.setObjectName(_fromUtf8("label_3"))
        self.gridLayout_2.addWidget(self.label_3, 17, 0, 1, 1)
        self.lineEdit_ionization_time = QtWidgets.QLineEdit(self.frame)
        self.lineEdit_ionization_time.setMinimumSize(QtCore.QSize(50, 0))
        self.lineEdit_ionization_time.setMaximumSize(QtCore.QSize(55, 16777215))
        self.lineEdit_ionization_time.setObjectName(_fromUtf8("lineEdit_ionization_time"))
        self.gridLayout_2.addWidget(self.lineEdit_ionization_time, 16, 1, 1, 1)
        self.lineEdit_recollision_time = QtWidgets.QLineEdit(self.frame)
        ...
        self.gridLayout_2.addWidget(self.lineEdit_recollision_time, 17, 1, 1, 1)
        self.gridLayout.addLayout(self.gridLayout_2, 0, 0, 1, 1)
        self.horizontalLayout.addWidget(self.frame)
        self.verticalLayout = QtWidgets.QVBoxLayout()
        self.verticalLayout.setObjectName(_fromUtf8("verticalLayout"))
        self.graphicsView_field_graph = PlotWidget(Form)
        self.graphicsView_field_graph.setObjectName(_fromUtf8("graphicsView_field_graph"))
        self.verticalLayout.addWidget(self.graphicsView_field_graph)
        self.graphicsView_pos_graph = PlotWidget(Form)
        self.graphicsView_pos_graph.setObjectName(_fromUtf8("graphicsView_pos_graph"))
        self.verticalLayout.addWidget(self.graphicsView_pos_graph)
        ...
        self.verticalLayout.addWidget(self.graphicsView_energy_graph)
        self.horizontalLayout_2 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_2.setObjectName(_fromUtf8("horizontalLayout_2"))
        spacerItem4 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_2.addItem(spacerItem4)
        self.pushButton_chooseFolder = QtWidgets.QPushButton(Form)
        ...
        Form.setTabOrder(self.lineEdit_approx_sb, self.lineEdit_recollision_duration)
        Form.setTabOrder(self.lineEdit_recollision_duration, self.lineEdit_tot_ke_rec)
    ...
    def retranslateUi(self, Form):
        Form.setWindowTitle(_translate("Form", "Three Step Modeler", None))
        ...
        self.label_recollision_time.setText(_translate("Form", "Duration (ps)", None))
        self.label_2.setText(_translate("Form", "Ionization Time (fs)", None))
        self.label_3.setText(_translate("Form", "Recollision Time (fs)", None))
